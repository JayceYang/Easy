...
{
    return [[[[NSFileManager defaultManager] URLsForDirectory:NSLibraryDirectory inDomains:NSUserDomainMask] lastObject] URLByAppendingPathComponent:[self.modelFileName stringByAppendingString:@".sqlite"]];
}
