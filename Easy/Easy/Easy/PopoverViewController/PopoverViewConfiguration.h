...
#define kGradientBottomColor [UIColor colorWithRed:.1f green:.1f blue:.1f alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:.3f green:.3f blue:.3f alpha:kBoxAlpha]
